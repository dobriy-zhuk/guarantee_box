...
function new_event(event) {
    ...
    $("#cancel-button").click(function() {
        $("#kids_name").removeClass("error-input");
        $("#parents_name").removeClass("error-input");
    ...
    $("#ok-button").unbind().click({date: event.data.date}, function() {
        ...
        var kids_name = $("#kids_name").val().trim();
        var phone = $("#phone").val().trim();
        var day = parseInt($(".active-date").html());
        // Basic form validation
        if(parents_name.length === 0) {
            $("#parents_name").addClass("error-input");
        }
        else if(kids_name.length === 0) {
            $("#kids_name").addClass("error-input");
        }
